...
func easyjsonCea158a8DecodeForumInternalPkgDelivery(in *jlexer.Lexer, out *ErrorMessage) {
...
func easyjsonCea158a8EncodeForumInternalPkgDelivery(out *jwriter.Writer, in ErrorMessage) {
	out.RawByte('{')
	first := true
	_ = first
	{
